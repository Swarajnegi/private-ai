...
**Goal:** Build agents that plan, use tools, and execute tasks.

| # | Sub-Phase | Status |
|---|-----------|--------|
| 3.1 | Function Calling | ⬜ |
| 3.2 | Tool Design & Registration | ⬜ |
...
**Goal:** Build Router → Specialist → Aggregator pattern.

| # | Sub-Phase | Status |
|---|-----------|--------|
| 4.1 | Local Model Loading | ⬜ |
...
**Goal:** Integrate specialized models for code, science, medical.

| # | Sub-Phase | Status |
|---|-----------|--------|
| 5.1 | Fine-Tuning Basics (LoRA) | ⬜ |
| 5.2 | Code Specialist (DeepSeek) | ⬜ |
| 5.3 | Science Specialist | ⬜ |
| 5.4 | Medical Specialist | ⬜ |
